...
namespace GPURenderer
{
  public static class SceneLibExtensions
  {
    ...
    public static List<Vector3> PositionsToVector3List(this TriangleBase polygon)
    {
    ...
    public static List<Vector3> DiffuseColorsToVector3List(this TriangleBase polygon)
    {
      var vectorList = new List<Vector3>();
      foreach (var vertex in polygon.Vertices)
      {
    ...
    public static List<Vector3> NormalsToVector3List(this TriangleBase polygon)
    {
      var vectorList = new List<Vector3>();
      foreach (var vertex in polygon.Vertices)
      {
    ...
    public static List<Vector3> SpecularColorsToVector3List(this TriangleBase polygon)
    {
      var vectorList = new List<Vector3>();
      foreach (var vertex in polygon.Vertices)
      {
    ...
    public static List<Vector3> TextureCoordinatesToVector3List(this TriangleBase polygon)
    {
      var vectorList = new List<Vector3>();
      foreach (var vertex in polygon.Vertices)
      {
